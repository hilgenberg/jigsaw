...
template<typename T> struct M2
{
	...
	M2(){ }
	explicit M2(T x) : a11(x), a12(0), a21(0), a22(x){ }
	M2(T a11, T a12, T a21, T a22) : a11(a11), a12(a12), a21(a21), a22(a22) {}
...
template<typename T> struct M3
{
	...
	explicit M3(T x) : a11(x), a12(0), a13(0), a21(0), a22(x), a23(0), a31(0), a32(0), a33(x){ }
	
	M3(T a11, T a12, T a13, T a21, T a22, T a23, T a31, T a32, T a33) :
		a11(a11), a12(a12), a13(a13),
		a21(a21), a22(a22), a23(a23),
		a31(a31), a32(a32), a33(a33)
	{}

	inline constexpr M3(const M3 &m) = default;
...
template<typename T> inline P3<T> operator * (const P3<T> &v, const M3<T> &m)
{
	P3<T> w;
...
template<typename T> struct M4
{
	...
	{}
	explicit M4(const M3<T> &m) : 
	a11(m.a11), a12(m.a12), a13(m.a13), a14(0),
	a21(m.a21), a22(m.a22), a23(m.a23), a24(0),
	a31(m.a31), a32(m.a32), a33(m.a33), a34(0),
	...
	template<typename S> explicit operator M4<S> () const
	{
		M4<S> m;
		m.a11 = (S)a11; m.a12 = (S)a12; m.a13 = (S)a13; m.a14 = (S)a14;
		m.a21 = (S)a21; m.a22 = (S)a22; m.a23 = (S)a23; m.a24 = (S)a24;
		m.a31 = (S)a31; m.a32 = (S)a32; m.a33 = (S)a33; m.a34 = (S)a34;
		m.a41 = (S)a41; m.a42 = (S)a42; m.a43 = (S)a43; m.a44 = (S)a44;
		return m;
	}
	inline operator       T* ()      { return (T*)this; }
	inline operator const T* () const{ return (T*)this; }
...
template<typename T> inline P3<T> operator * (const P4<T> &v, const M4<T> &m)
{
	P4<T> w;
